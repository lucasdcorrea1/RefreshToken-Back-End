...
namespace Whodo.Autentication.Services
{
    public static class TokenService
    {
        ...
        public static ClaimsPrincipal GetPrincipalFromExpuredToken(string token)
        {
        ...
        public static void SaveRefrashToken(string userName, string refreshToken)
        {
        ...
        public static void DeleRefreshToken(string userName, string refreshToken)
        {
